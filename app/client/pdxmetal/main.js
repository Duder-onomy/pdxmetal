...
require(['backbone', 'masseuse', 'jquery', 'routers/pdxmetal', 'routers/authorization', 'utilities/calls/customizeSync', 'views/navigation/view'],
    function (Backbone, masseuse, $, pdxmetalRouter, AuthorizationRouter, customizeSync, NavigationView) {
        'use strict';
