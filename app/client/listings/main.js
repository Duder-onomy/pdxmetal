...
require(['backbone', 'masseuse', 'jquery', 'routers/listings', 'routers/authorization', 'utilities/calls/customizeSync', 'views/navigation/view'],
    function (Backbone, masseuse, $, listingsRouter, AuthorizationRouter, customizeSync, NavigationView) {
        'use strict';
